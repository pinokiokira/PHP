  ...
  <div class="leftmenu">
	...
	<?php } ?>
		...
		<?php $sql_count3 = "Select id  from employee_messages where emp_id in (SELECT id FROM employees WHERE email = '{$_SESSION["email"]}') and readd='no' ";
          ...
          <!-- <li <?php //  echo $page=='storepoint.php'?'class="active"':'"';?>><a href="storepoint.php"><span style="margin-right:10px;" class="iconfa-envelope"></span>Messages</a></li> -->
            <?php if (isset($_SESSION['StorePointVendorID']) && $_SESSION['StorePointVendorID']!=""){
				...
				$tpid = $p_countq['tpid'];
			?>
		<li class="dropdown <?php echo ($page=='sales.php' || $page=='shipping.php' || $page=='purchases.php' || $page=='storepoint.php' || $page=='storepoint_clients.php' || $page=='backoffice_purchases_compleated.php'  ||  $page=='backoffice_purchases.php')?'active':'';?>"><a href="">
			<div class="iconfa-th" style="float:left;width:25px;margin-top:4px;"></div>
			Sales</a>
			<?
			...
			?>
			<ul <?php echo ($page=='sales.php' || $page=='shipping.php' || $page=='purchases.php' || $page=='storepoint.php' || $page=='storepoint_clients.php' || $page=='backoffice_purchases_compleated.php'  ||  $page=='backoffice_purchases.php')?'style="display: block;"':'';?>>
			  <li <?php echo $page=='sales.php'?'class="active"':'"';?>><a href="sales.php">Sales</a></li>
			  ...
			  <li <?php echo $page=='purchases.php' || $page=='backoffice_purchases_compleated.php'  ||  $page=='backoffice_purchases.php'?'class="active"':'"';?>><a href="purchases.php">Purchases <?php if($tpid>0){ echo '('.$tpid.')'; }?></a></li>
			  <li <?php echo $page=='shipping.php'?'class="active"':'"';?>><a href="shipping.php">Shipping</a></li>
			</ul>
		  </li> 	
			
  		<?php } ?>
		
		<li class="dropdown <?php echo ($page=='receiving_in.php' || $page=='receiving_allocate.php' || $page=='receiving_home.php')?'active':'';?>"><a href="">
			<div class="iconfa-list-alt" style="float:left;width:25px;margin-top:4px;"></div>Receiving</a>
			<ul <?php echo ($page=='receiving_in.php' || $page=='receiving_allocate.php' || $page=='receiving_home.php')?'style="display: block;"':'';?>>
			  <li <?php echo $page=='receiving_in.php'?'class="active"':'"';?>><a href="receiving_in.php">IN</a></li>
			  <li <?php echo $page=='receiving_allocate.php'?'class="active"':'"';?>><a href="receiving_allocate.php">Allocate</a></li>
		...
		<?php /* ?><li class="dropdown <?php echo ($page=='storepoint.php'||$page=='storepoint_clients.php'||$page=='storepoint_messages_inquiry.php')?'active':'';?>">
         ...
         <?php /* ?> <li <?php echo $page=='shipping.php'?'class="active"':'"';?>><a href="shipping.php"><span style="margin-right:10px;" class="iconfa-truck"></span>Shipping</a></li><?php */ ?>

		  
		  
		  <li class="dropdown <?php echo ($page=='inventory.php'||$page=='backoffice_inventory.php')?'active':'';?>"><a href="">
			<div class="iconfa-cog" style="float:left;width:25px;margin-top:4px;"></div>
			Inventory</a>
			<ul <?php echo ($page=='inventory.php'||$page=='backoffice_inventory.php'||$page=='backoffice_enter_inventory.php'||$page=='backoffice_movements.php')?'style="display: block;"':'';?>>
			 <li class="dropdown <?php echo ($page=='inventory.php'||$page=='backoffice_inventory.php'||$page=='backoffice_enter_inventory.php'||$page=='backoffice_movements.php')?'active':'';?>"><a href="">Internal Inventory</a>
				<ul <?php echo ($page=='inventory.php'||$page=='backoffice_inventory.php'||$page=='backoffice_enter_inventory.php'||$page=='backoffice_movements.php')?'style="display: block;"':'';?>>
		  ...
		  <?php 
			...
			if(mysql_num_rows($q) > 0){
			  ...
			  <li class="dropdown"><a href="#">Inventory</a>
			   <ul <?php echo ($page=='setup_backoffice_global_items.php'||$page=='setup_backoffice_manage_items.php' || $page=='setup_backoffice_storerooms.php' || $page=='setup_backoffice_storeroom_priority.php' || $page=='setup_finance_global_items_add.php')?'style="display: block;"':'';?>>                               
				   ...
				   <li <?php echo ($page=='setup_backoffice_manage_items.php' || $page=='setup_finance_global_items_add.php')?'class="active"':'"';?>><a href="setup_backoffice_manage_items.php">Manage Items</a></li>
