...
and (orientation : landscape) {
    .maincontent, .rightpanel, .leftpanel, .header{
        display:block;
    }
    .turnDeviceNotification, .orient{
         display:none;
    }
    .topbar{
         display:block;
...
#loading-header {
  ...
  .logwindow-inner h5 {
	...
	.capital_word{text-transform:capitalize;}
	.logwindow {z-index: 9999}
    ...
    var locgrowl = true;
	   ...
	   jQuery(window).load(function() {
		...
		jQuery(document).ready(function(){
			...
			jQuery(".empthumb").on("click", function () {
				if (empgrowl){
					jQuery.jGrowl("HELLO");
					empgrowl = false;
				}
