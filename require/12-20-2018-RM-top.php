...
<?php  
    $helpcount="0";
    $helpsql = "Select count(help_id) as helpcount from help WHERE to_type = 'Team' AND to_employee_master={$_SESSION["client_id"]} AND help.status = 'unread'"; 
        ...
        <span class="headmenu-label">Help</span>
			...
			<li class="right">
				<div class="userloggedinfo">
					 <?php 	$queryimg = 	mysql_query("select em.image , V.StorePoint_Image from employees_master em LEFT JOIN vendors V ON v.id = em.StorePoint_vendor_id WHERE empmaster_id='". $_SESSION['client_id'] ."'");
					...
					$client_img = @mysql_fetch_array($queryimg);?>
                       ...
                       ?>
                          <img src="<?php echo APIPHP;?>images/<?php echo $client_img["StorePoint_Image"];?>" onerror="this.src='images/Default - User.png'" alt="" style="padding-right:3px;max-height: 80px;max-width: 80px;height:80px;width:80px;"/>
                      <?php } ?>
											</span>
                      <span class="empthumb">
					...
					<div class="userinfo notranslate">
						...
						<ul class="notranslate">
							...
							<li><a href="help.php"><?php echo 'Help'; ?> (<span id="countmsg" style="line-height: 13px;"><?php echo $helpcount;?></span>)</a></li>
...
.userloggedinfo ul li a { padding: 4px 5px 3px 5px; }
<? // } ?>
</style>
