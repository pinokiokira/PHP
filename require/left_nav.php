...
<div class="leftpanel">
  <div class="leftmenu">
	...
	?>
		...
		<li <?php echo $page=='purchase_orders.php'?'class="active"':'"';?>><a href="purchase_orders.php"><span style="margin-right:10px;" class="iconfa-user"></span>Purchase Order</a></li>
		...
		<li class="dropdown <?php echo ($page=='desc_dashboard.php' || $page=='shipping.php' || $page=='desc_trucks.php' || $page=='desc_orders.php' || $page=='desc_matrix.php' || $page=='desc_driver.php')?'active':'';?>">
			<a href=""><div class="iconfa-truck" style="float:left;width:25px;margin-top:4px;"></div>Distribution</a>
			<ul <?php echo ($page=='desc_dashboard.php' || $page=='shipping.php' || $page=='desc_trucks.php' || $page=='desc_orders.php' || $page=='desc_routes.php' || $page=='desc_matrix.php' || $page=='desc_driver.php') ?'style="display: block;"':'';?>>
			  ...
			  <li <?php echo $page=='desc_driver.php'?'class="active"':'"';?>><a href="desc_driver.php">Driver Schedule</a></li>
			</ul>
		</li>
