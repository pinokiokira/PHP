...
<div class="leftpanel">
  <div class="leftmenu">
	...
	<?php } ?>
		...
		<li class="dropdown <?php echo ($page=='storepoint.php'||$page=='storepoint_clients.php')?'active':'';?>">
			...
			?>
			Clients</a>
			<ul <?php echo ($page=='storepoint.php'||$page=='storepoint_clients.php')?'style="display: block;"':'';?>>
