    ...
    <ul class="headmenu">
      ...
      <li class="right">
        <div class="userloggedinfo">
           <?php  $queryimg =   mysql_query("select em.image , V.StorePoint_Image from employees_master em LEFT JOIN vendors V ON V.id = em.StorePoint_vendor_id WHERE empmaster_id='". $_SESSION['empmaster_id'] ."'");
