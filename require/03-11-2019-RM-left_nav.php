...
<div class="leftpanel">
  <div class="leftmenu">
	...
	?>
		...
		<li class="dropdown <?php echo ($page=='shipping.php' || $page=='desc_trucks.php' || $page=='desc_orders.php' || $page=='desc_manual_matrix.php' )?'active':'';?>">
			<a href=""><div class="iconfa-truck" style="float:left;width:25px;margin-top:4px;"></div>Distribution</a>
			<ul <?php echo ($page=='shipping.php' || $page=='desc_trucks.php' || $page=='desc_orders.php' || $page=='desc_routes.php' || $page=='desc_manual_matrix.php') ?'style="display: block;"':'';?>>
			  ...
			  <li <?php echo $page=='desc_manual_matrix.php'?'class="active"':'"';?>><a href="desc_manual_matrix.php">Manual Matrix</a></li>
			</ul>
		</li>
