		...
		<?php $sql_count3 = "Select id  from employee_messages where emp_id in (SELECT id FROM employees WHERE email = '{$_SESSION["email"]}') and readd='no' ";
          ...
          <!-- <li <?php //  echo $page=='storepoint.php'?'class="active"':'"';?>><a href="storepoint.php"><span style="margin-right:10px;" class="iconfa-envelope"></span>Messages</a></li> -->
            <?php if (isset($_SESSION['StorePointVendorID']) && $_SESSION['StorePointVendorID']!=""){
				...
				$tpid = $p_countq['tpid'];
			?>
		<li class="dropdown <?php echo ($page=='shipping.php' || $page=='purchases.php' || $page=='storepoint.php' || $page=='storepoint_clients.php' || $page=='backoffice_purchases_compleated.php'  ||  $page=='backoffice_purchases.php')?'active':'';?>"><a href="">
			...
			?>
			<ul <?php echo ($page=='shipping.php' || $page=='purchases.php' || $page=='storepoint.php' || $page=='storepoint_clients.php' || $page=='backoffice_purchases_compleated.php'  ||  $page=='backoffice_purchases.php')?'style="display: block;"':'';?>>
