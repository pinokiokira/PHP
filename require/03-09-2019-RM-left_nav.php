...
<div class="leftpanel">
  <div class="leftmenu">
	...
	?>
		...
		<li class="dropdown <?php echo ($page=='shipping.php' || $page=='desc_trucks.php' || $page=='desc_orders.php' || $page=='desc_routes.php')?'active':'';?>">
			<a href=""><div class="iconfa-truck" style="float:left;width:25px;margin-top:4px;"></div>Distribution</a>
			<ul <?php echo ($page=='shipping.php' || $page=='desc_trucks.php' || $page=='desc_orders.php' || $page=='desc_routes.php')?'style="display: block;"':'';?>>
