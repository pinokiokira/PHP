...
//exit;
    $inv_item = mysql_real_escape_string($_REQUEST['item_i_id']);
...
<div class="mainwrapper">
  ...
  <div class="rightpanel">
    ...
    <div class="pageheader">
      ...
      <div class="pagetitle">
        <h5>List of the Available vehicles</h5>
        ...
        <div class="row-fluid">
            ...
            <table class="table table-bordered responsive" id="global_tbl">
              ...
              <tbody>
                ...
                <tr class="<?php if($selected==$row["id"]){ echo "selected-row";} ?> gradeX cl_order" id="<?php echo $row["id"];?>"
                  ...
                  <td class="center"><?php echo $row['qty_in_pack']; ?></td>
          ...
          <div class="span4">
            ...
            <div class="widgetcontent" style="padding: 0px !important;">
                <div class="clearfix">
              <h4 class="widgettitle">Add/Edit Vehicle</h4>
            </div>
                        ...
                        <form id="edit_from234" name="frm234" action="" method="post" class="edit_from" >
                          ...
                          <p>                  
                            ...
                            <span class="field">
                                      ...
                                      <p style="width:100%;">                  
                                        <label>Master Unit of Measure:<span style="color:#FF0000;">*</span></label>                    
                                      ...
                                      <p>
                                        <label>Qty In Master Unit of Measure: <span style="color:#FF0000;">*</span></label>
                                        <div class="field" style="float: left;  margin-top: -15px;   padding-bottom: 8px;  width: 100% !important;">
                                        <div class="selectouter12 select_w3">
