...
if($code_id!=""){
	...
	header('location:storepoint_items.php?group1='.$group1_inp.'&market='.$market_inp.'&msg=Item Added/Updated Successfully!');
}
...
jQuery(document).ready(function($){
	...
	if(msg!=""){		
		...
		jQuery('#popup_overlay').css({height:'100%'});
		setTimeout(function(){			
		jQuery(window).resize();
		},1000);
		//jQuery('#popup_container').offset({top:offset.top});
		//jQuery('#popup_container').css({margin:'0 0 0 0'});
		//alert(jQuery('.maincontentinner').height());
		//jQuery('#popup_container').css({margin:'-'+(jQuery('.maincontentinner').height()/4)+'px 0 0 0'});
	}
	...
	jQuery('#addcode').click(function(){
		...
		jQuery('#created_on').val('TeamPanel');
	...
	jQuery(".cl_order").live('click',function(){
		// alert();
			...
			jQuery('#vendor_internal_number').val(jQuery(this).data('vendor_internal_number'));
...
<div class="mainwrapper">
  ...
  <div class="rightpanel">
    ...
    <div class="pageheader">
      ...
      <div class="pagetitle">
        <h5>Browse through your items</h5>
        <h1>StorePoint - Items</h1>
      </div>
    </div>
    <!--pageheader-->
    <div class="maincontent">
      <div class="maincontentinner" style="padding-right:0;">
        <div class="row-fluid">
          <div class="span8" style="width:69%;float:left; overflow:auto;">
            <div class="clearfix">
            ...
            <table class="table table-bordered responsive" id="global_tbl">
              ...
              <tbody>
                ...
                <tr class="<?php if($selected==$row["id"]){ echo "selected-row";} ?> gradeX cl_order" id="<?php echo $row["id"];?>"
                  ...
                  <td><?php echo $row['qty_in_pack']; ?></td>
          ...
          <div class="span4">
            ...
            <div class="widgetcontent">
              <div class="widgetbox" id="fdetail">
                <form id="edit_from" onSubmit="return validate()" name="frm" action="" method="post" >
                  ...
                  <p>
                    ...
                    <span style="vertical-align:top;margin-left: -25px;" id="group_cancel_btn"><i style="margin-top: 5px;" class="icon-remove"></i></span> </span>
                     </p>
                  <p>
                    ...
                    <span style="vertical-align:top;  margin-left: -25px;" id="cancel_btn"><i style="margin-top: 5px;" class="icon-remove"></i></span> </span> </p>
                    <p>                  
				  ...
				  <p>
                    ...
                    <span class="field">
                    <input type="text" class="input-xlarge" id="pack_weight" value="" name="pack_weight">
                    </span> </p>
                  ...
                  <p>
                    ...
                    <div class="field" style="float: left;  margin-top: -15px;   padding-bottom: 8px;  width: 100% !important;">
                    <div class="selectouter12 select_w3">
                    <select name="qty_in_pack_unit_type" id="qty_in_pack_unit_type" style="width:270px;" >
                      <option value="" >- - - Select Unit Type - - -</option>
                      <?php
						$res_unit_type = mysql_query($unittype);
				...
				<div id="tax_per" style="display:none;"> 
                  ...
                  <!-- <p>
                        ...
                        <span class="field">
                        <select onChange="javascript:if(this.value=='yes'){jQuery('#tax_per').show();}else{jQuery('#tax_per').hide();}" style="width:270px;" id="ni_taxable" name="ni_taxable">
                  ...
                  <p>
                    ...
                    <span class="field">
                    <input type="text" class="input-xlarge" id="promotion" value="" name="promotion">
                    </span> </p>
                  <p>
                  ...
                  <p class="retails" style="display:none;">
                   ...
                   <p><strong> Supplied Information </strong> </p>
                  
                    <label>Purchase From:</label>
                    <span class="field">                    
                        <div id="clientsearch" class="input-append">
                            <input autocomplete="off" name="vendors" onKeyDown="javascript:if(event.keyCode==13){getvendor1(2);return false;}"  type="text" id="vendors" tabindex="0"  style="width:228px;"  />
                  ...
                  <p>
                    ...
                    <span class="field">
                    <input type="text" class="input-xlarge" readonly id="created_on" value="TeamPanel " name="created_on">
                    </span> </p>
                  <p>
                  ...
                  <div id="for_edit" style="display:none;">
                    <p>
                      <label>Last On:</label>
                      <span class="field">
                      <input type="text" class="input-xlarge" id="last_on" value="TeamPanel" readonly name="last_on">
                      </span> </p>
                    <p>
                      <label>Last By:</label>
                      <span class="field">
