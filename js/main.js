            ...
            if (userdata.StorePoint_vendor_Id != "" && userdata.StorePoint_vendor_Id != 0 && typeof userdata.StorePoint_vendor_Id !== 'undefined' && userdata.StorePoint_vendor_Id!=null) {				
                jQuery.ajax({
                    ...
                    success: function (data) {
							...
							jQuery("#created_on").val(data.created_on);
                            jQuery("#created_by").val(data.created_by);
                            jQuery("#created_datetime").val(data.created_date);
                            jQuery("#last_on").val(data.last_on);
                            jQuery("#last_by").val(data.last_by);
                            jQuery("#last_datetime_x").val(data.last_datetime);
