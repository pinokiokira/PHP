...
if(isset($_POST) && $_POST['sub']=="enter_sub"){
    ...
    if($_POST['change_sub']=="enter_sub"){
        ...
        header('location:pricing_sheet.php?group1='. $group1 .'&market='. $market .'&msg=Inventory Was Updated Successfully!');
    }else{
        header('location:pricing_sheet?group1='. $group1 .'&market='. $market .'&msg=Add change to the Group!');
    }
...
.widgetcontent { background: #fff;padding: 15px 12px;border: 3px solid #0866c6;margin-bottom: 20px; }
...
<div class="mainwrapper">
  ...
  <div class="rightpanel">
    ...
    <li>Pricing <span class="separator"></span> Price Sheet</li>
            ...
            <div style="float: right;margin-top: 10px;" class="messagehead">
                <p style="float:left;">
                     <?php 
                                    ...
                                    echo "<script>console.log('asdasd".$query1."');</script>";
                                ?>
                   <span>                    
      ...
      <div class="maincontentinner">
        ...
        <div class="row-fluid">
          ...
          <div class="span8" style="width:100%;float:left;">
              <!--   <div class="clearfix">
                <h4 class="widgettitle">Item Pricing</h4> -->
              </div>
                    ...
                    <?php $i++;  ?>
                        <div class="peoplewrapper" id="<?php echo "row_".$row_act['loc_id']; ?>">
                            ...
                            <div class="peopleinfo">
                                ...
                                <ul style="margin: 0px;">
                                    <li><span>GROUP #</span> <?php echo $row_act['group_name']; ?></li>
                                    <li><span>ITEM DESCRIPTION: </span> </li>
                                    <li><span>PACK: </span> <?php 
        ...
        if (search_inpt!=null) {
            ...
            if (search_inpt.length > 0) {
                if(search_inpt.length < 3) {
                    ...
                    if(val==""){ /*val = 'All';*/ }
                    window.location="pricing_sheet.php?group1="+val+"&market="+dummy_market+"&search_txt1="+jQuery('#search_txt1').val();
                }
            } else{
