	...
	try{
		...
		if(isset($vendor_id) && $vendor_id>0)
		{
                ...
                if (mysql_num_rows($result)>0){						
						...
						$sql = "SELECT id,concat(name,' ','(ID: ',id,')') name FROM locations where id = '".$row["location_link"]."'";
						...
						$response['location_link'] =  $locationName;
						$response['location_id'] =  $row["location_link"];
