        ...
        <div class="pageheader">
            <form action="" method="post" class="searchbar" onSubmit="return false;">
                ...
                <select id="report_select1" class="buttonReport">
                    ...
                    <option value="stroom" selected>Inventory by Storeroom</option>
        ...
        <div class="maincontent">
            <div class="maincontentinner">   
              <?/*	<div class="report-header">
              		<span class="tabname"> <?=$_SESSION['user_full_name'];?> - <?=$_SESSION["user"];?></span> <div class="tabtitle">Inventory by Storeroom</div><br/>
