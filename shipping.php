...
<html>
    <head>
        ...
        <style>
			...
			.line_bye{	background-color:#808080;color:#000000 !important; }
			.line_truck{	background-color:#808080;color:#000000 !important; }
        </style>
        <script type="text/javascript">
            jQuery(document).ready(function ($) {				
       
var baysTable = jQuery('#bays_tbl').dataTable({
				...
				jQuery('#bays_tbl_wrapper .dataTables_filter input').unbind('keypress keyup').bind('keypress keyup', function(e){
					jQuery('.line_bye').removeClass('line_bye');
					jQuery("#row_"+jQuery('#bays_back').val()).addClass('line_bye');
				});
				
				/* if(jQuery('#bays_tbl>tbody>tr:first>td').html()!="No data available in table"){
					jQuery('#bays_tbl>tbody>tr:first').addClass('line3');
				} */
				...
				jQuery('#vehicles_tbl_wrapper .dataTables_filter input').unbind('keypress keyup').bind('keypress keyup', function(e){
					jQuery('.line_truck').removeClass('line_truck');
					jQuery("#row_vehi_"+jQuery('#truck_back').val()).addClass('line_truck');
				...
				/* jQuery(".line3").click(function () {
					jQuery('.line3').removeClass('line3');
					var row_id = jQuery(this).data('row_id');
					jQuery("#row_"+row_id).addClass('line3');
				}); */
				
				
				jQuery('#bays_tbl_filter > input[type=search]').click( function() {
					var val = jQuery("#bays_tbl_filter").find("input").val();
					console.log(val);
				});

            });
			
			function get_detail_of_bye(id){
				jQuery('.line_bye').removeClass('line_bye');
				jQuery('#bays_back').val(id);
				jQuery("#row_"+id).addClass('line_bye');
				console.log('get_detail_of_bye : '+id);
			}
			
			function get_detail_of_truck(id){
				jQuery('.line_truck').removeClass('line_truck');
				jQuery('#truck_back').val(id);
				jQuery("#row_vehi_"+id).addClass('line_truck');
				console.log('get_detail_of_truck : '+id);
			}
        ...
        <div class="mainwrapper">
            ...
            <div class="rightpanel">
                <ul class="breadcrumbs">
                    ...
                    <li>Distribution</li>
                    <li><span class="separator"></span> Distribution </li>
                    ...
                    <div class="maincontentinner" >
                        ...
                        <div class="row-fluid" id="#!" style="margin: 6px;">
                            <div class="span8 " style="width:28%;float:left; overflow:auto;">
                                ...
                                <div class="widgetcontent  DistributionBox">
                                    <table id="bays_tbl" class="table responsive table-bordered table-infinite">
										<colgroup>
											<col class="con0"/>
											<col class="con1"/>											
										</colgroup>
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $bays = mysql_query("SELECT * FROM vendor_bays WHERE status='Active' && vendor_id='".$vendor_id."'");
                                            while($row_act = mysql_fetch_array($bays))
                                            { ?>
                                            <tr onClick="get_detail_of_bye(<?php echo $row_act['vendor_bays_id']; ?>)" data-row_id="<?php echo $row_act['vendor_bays_id']; ?>"  id="row_<?php echo $row_act['vendor_bays_id']; ?>">
                                                <td><?= $row_act['bay_code']; ?></td>
                                                <td><?= $row_act['bay_name']; ?></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="span8" style="width:20%;float:left; overflow:auto;">
                                <div class="clearfix1">
                                    <h4 class="widgettitle">Collected Items</h4>
                                </div>
                                <div class="widgetcontent DistributionBox"></div>
                            </div>

                            <div class="span8" style="width:28%;float:left; overflow:auto;">
                                <div class="clearfix1">
                                    <h4 class="widgettitle">Trucks</h4>
                                </div>
                                <div class="widgetcontent DistributionBox">
                                    <table id="vehicles_tbl" class="table responsive table-bordered table-infinite">
										<colgroup>
											<col class="con0"/>
											<col class="con1"/>											
										</colgroup>
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $vehicles_data = mysql_query("SELECT * FROM vendor_vehicles WHERE status='Active' && vendor_id='".$vendor_id."'");
                                            while($row_veh = mysql_fetch_array($vehicles_data))
                                            { ?>
                                            <tr onClick="get_detail_of_truck(<?php echo $row_veh['vendor_vehicles_id']; ?>)" id="row_vehi_<?php echo $row_veh['vendor_vehicles_id']; ?>">
            ...
            <div class="maincontentinner">
                <div class="row-fluid" id="movements">
                    ...
                    <div class="span4">
						...
						<div class="widgetcontent  DistributionBox">
							<table id="bays_tbl" class="table table-bordered responsive">
								<input type="hidden" id="bays_back">
								<colgroup>
									<col class="con0"/>
									<col class="con1"/>											
								</colgroup>
					...
					<div class="span4">
						...
						<div class="widgetcontent DistributionBox">
							<table id="vehicles_tbl" class="table table-bordered responsive">
								<input type="hidden" id="truck_back">
								<colgroup>
									<col class="con0"/>
									<col class="con1"/>											
								</colgroup>
        ...
        <script type="text/javascript">
            /* jQuery(function(){
                ...
                var w = jQuery(window).height()-x;
                 jQuery('.DistributionBox').css({'height':w+'px'});
            }); */
        </script>
