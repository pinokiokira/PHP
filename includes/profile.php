...
?>
		...
		<script type="text/javascript">
			...
			window.opener.updateValue('client_id',"<?=$user_data->identifier?>");
			window.opener.updateValue('name_title',"<?=$user_data->displayName?>");
			window.opener.updateValue('phone',"<?=$user_data->phone?>");
			window.opener.updateValue('address',"<?=$user_data->address?>");
			window.opener.updateValue('country',"<?=$user_data->country?>");
			window.opener.updateValue('state',"<?=$user_data->region?>");
			window.opener.updateValue('city',"<?=$user_data->city?>");
			window.opener.updateValue('zip',"<?=$user_data->zip?>");
			window.opener.updateValue('gender',"<?=$gender?>");
			window.opener.updateValue('dob',"<?=$dob?>");
			window.opener.updateValue('profile_image',"<?=$user_data->photoURL?>"); 
