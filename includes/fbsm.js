  window.fbAsyncInit = function() {
   	...
   	function Login()
	{
		FB.login(function(response) {
		 ...
		 },{scope: 'email, user_mobile_phone, user_photos,user_videos, user_about_me, user_birthday, user_hometown, user_website, read_stream, offline_access, publish_stream, read_friendlists'});
	
	
	}

  function getUserInfo() {
	    FB.api('/me?fields=id,name,location,hometown,gender,birthday,email,first_name,last_name', function(response) {
		  ...
		  document.getElementById('client_idsm').value = response.id;
		...
		//  document.getElementById('dob').value = response.birthday;
		  document.getElementById('smprofile_image').value = "https://graph.facebook.com/"+response.id+"/picture?width=150&height=150";
