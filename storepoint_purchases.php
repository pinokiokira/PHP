...
$vendor_id = $vender['StorePoint_vendor_Id'];
 ...
 $query_act = "SELECT p.id,p.status,
				 ...
				 gc.symbol, l.name as location_name, l.city,st.name as state_name,lt.name as location_type,CONCAT(e.first_name,' ',e.last_name) as emp_name,l.zip,st.code,p.vendor_invoice_num
				 FROM purchases as p
...
$query_his = "SELECT p.id,p.status,
				 ...
				 gc.symbol,l.name as location_name, l.city,st.name as state_name,lt.name as location_type,CONCAT(e.first_name,' ',e.last_name) as emp_nam,p.vendor_invoice_num
				 FROM purchases as p
				 LEFT JOIN locations l ON l.id = p.location_id
				 LEFT JOIN global_currency as gc ON gc.id = l.currency_id
				 LEFT JOIN states as st on st.id = l.state				 
  ...
  <div class="rightpanel">
    ...
    <div class="pageheader"> 
            ...
            <div class="pull-right" style=" margin-top: 14px;">
                <a href="backoffice_purchases.php?flag" class="btn btn-success btn-large new_purchase pull-right">Add</a>
                </div>
      <div class="pageicon"><span class="iconfa-tags"></span></div>
      <div class="pagetitle">
        <h5>Browse through your Purchases</h5>
        <h1>StorePoint - Purchases</h1>
      </div>
    </div>
    <!--pageheader-->
                  ...
                  <table id="licence_table" class="table table-bordered responsive" style="height: auto !important;">
					...
					?>
                    	<tr onClick="get_detail(<?php echo $row_act['id']; ?>)" data-comments="<?php echo $row_act['comments']; ?>" id="row_<?php echo $row_act['id']; ?>">
                            ...
                            <td class="center" style="vertical-align:middle;">&nbsp;<?php echo getstatus($row_act['status']); ?></td>                            
                            ...
                            <a href="backoffice_purchases.php?flag&purchase_id=<?php echo $row_act['id']; ?>" >
                  ...
                  <table id="licence_table1" class="table table-bordered responsive">
                    ...
                    <tbody>
                     <?php while($row_his = mysql_fetch_array($res_his)){?>
                    	<tr onClick="get_detail(<?php echo $row_his['id']; ?>)" data-comments="<?php echo $row_his['comments']; ?>" id="row_<?php echo $row_his['id']; ?>">
                            ...
                            <td class="center" style="vertical-align:middle;">&nbsp;<?php echo getstatus($row_his['status']); ?></td>
                            ...
                            <td class="center" style="vertical-align:middle;"><a href="backoffice_purchases_compleated.php?flag&purchase_id=<?php echo $row_his['id']; ?>" >
                            <img title="Edit"  src="images/edit.png" ></a>
                            <img  src="images/icons/search.png" ></td>
